...
/* loaded from: C:\Users\niyaz\Downloads\universal\smali\com\google\android\gms\internal\firebase-auth-api\zzanc.smali */
interface zzanc {
    double zza();

    <T> void zza(T t4, zzanb<T> zzanbVar, zzaku zzakuVar);
    ...
    <T> void zzb(T t4, zzanb<T> zzanbVar, zzaku zzakuVar);

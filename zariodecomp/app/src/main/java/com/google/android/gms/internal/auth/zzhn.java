...
/* loaded from: C:\Users\niyaz\Downloads\universal\smali\com\google\android\gms\internal\auth\zzhn.smali */
public final class zzhn {
    ...
    static {
        zzhn zzhnVar = new zzhn("DOUBLE", 0, zzho.zzd, 1);
        zza = zzhnVar;
        zzhn zzhnVar2 = new zzhn("FLOAT", 1, zzho.zzc, 5);
        zzb = zzhnVar2;
        zzho zzhoVar = zzho.zzb;
        zzhn zzhnVar3 = new zzhn("INT64", 2, zzhoVar, 0);
        zzc = zzhnVar3;
        zzhn zzhnVar4 = new zzhn("UINT64", 3, zzhoVar, 0);
        zzd = zzhnVar4;
        zzho zzhoVar2 = zzho.zza;
        ...
        zzg = zzhnVar7;
        zzhn zzhnVar8 = new zzhn("BOOL", 7, zzho.zze, 0);
        zzh = zzhnVar8;
        zzhn zzhnVar9 = new zzhn("STRING", 8, zzho.zzf, 2);
        zzi = zzhnVar9;
        zzho zzhoVar3 = zzho.zzi;
        zzhn zzhnVar10 = new zzhn("GROUP", 9, zzhoVar3, 3);
        zzj = zzhnVar10;
        zzhn zzhnVar11 = new zzhn("MESSAGE", 10, zzhoVar3, 2);
        zzk = zzhnVar11;
        zzhn zzhnVar12 = new zzhn("BYTES", 11, zzho.zzg, 2);
        zzl = zzhnVar12;
        zzhn zzhnVar13 = new zzhn("UINT32", 12, zzhoVar2, 0);
        zzm = zzhnVar13;
        zzhn zzhnVar14 = new zzhn("ENUM", 13, zzho.zzh, 0);
        zzn = zzhnVar14;
    ...
    private zzhn(String str, int i, zzho zzhoVar, int i5) {
        this.zzt = zzhoVar;
    }

...
/* loaded from: C:\Users\niyaz\Downloads\universal\smali\com\google\android\gms\internal\fido\zzaz.smali */
public abstract class zzaz extends zzav implements List, RandomAccess {
    ...
    public zzaz subList(int i, int i5) {
        zzap.zze(i, i5, size());
        int i6 = i5 - i;
        return i6 == size() ? this : i6 == 0 ? zzbs.zza : new zzay(this, i, i6);
    }

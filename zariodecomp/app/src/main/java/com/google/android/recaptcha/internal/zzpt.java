...
/* loaded from: C:\Users\niyaz\Downloads\universal\smali\com\google\android\recaptcha\internal\zzpt.smali */
final class zzpt {
    public static /* bridge */ /* synthetic */ void zza(byte b5, byte b6, byte b7, byte b8, char[] cArr, int i) throws zznn {
        if (!zze(b6)) {
  ...
  0x0016: PHI (r2v3 byte) = (r2v2 byte), (r2v9 byte) binds: [B:9:0x0011, B:11:0x0015] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b5, byte b6, char[] cArr, int i) throws zznn {
        if (b5 < -62 || zze(b6)) {
            throw new zznn("Protocol message had invalid UTF-8.");
        }

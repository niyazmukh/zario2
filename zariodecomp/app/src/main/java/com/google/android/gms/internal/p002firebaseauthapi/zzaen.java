...
/* loaded from: C:\Users\niyaz\Downloads\universal\smali\com\google\android\gms\internal\firebase-auth-api\zzaen.smali */
public final class zzaen {
    ...
    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.f5536b) ? str : String.format(a.k(str, " [ %s ]"), status.f5536b);
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C0805i) {
            return ((C0805i) exc).f9219a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof C0805i) {
            return ((C0805i) exc).f9219a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C0805i) {
            return ((C0805i) exc).f9219a.endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    */
    public static l2.h zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 550
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaen.zza(com.google.android.gms.common.api.Status):l2.h");
    }

    public static h zza(Status status, AbstractC0799c abstractC0799c, String str, String str2) {
        int i = status.f5535a;
        if (i != 17012 && i != 17007 && i != 17025) {
            return zza(status);
        }
        return new m(zza(i), zza(zzb(i), status));
    }

    public static l zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, o oVar) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaasVar);
        Pair<String, String> pair = zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<t> listZzc = zzaasVar.zzc();
        ...
        List<t> listZzc2 = zzaasVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        for (t tVar2 : listZzc2) {
            if (tVar2 instanceof C0796B) {
                arrayList2.add((C0796B) tVar2);
            }
        }
        List<t> listZzc3 = zzaasVar.zzc();
        String strZzb = zzaasVar.zzb();
        C.f(listZzc3);
        C.d(strZzb);
        ArrayList arrayList3 = new ArrayList();
        ArrayList arrayList4 = new ArrayList();
        for (t tVar3 : listZzc3) {
            if (tVar3 instanceof y) {
                arrayList3.add((y) tVar3);
            } else if (tVar3 instanceof C0796B) {
                arrayList4.add((C0796B) tVar3);
            } else {
                throw new IllegalArgumentException("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(tVar3.c()));
            }
        }
        f fVar = firebaseAuth.f6368a;
        fVar.a();
        zzaasVar.zza();
        C.d(fVar.f8772b);
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof C0805i) {
            return ((C0805i) exc).f9219a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}

...
/* loaded from: C:\Users\niyaz\Downloads\universal\smali\X2\m.smali */
public final class m extends u0.k {

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ o f3845d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(o oVar, AppDatabase_Impl appDatabase_Impl) {
        super(appDatabase_Impl);
        this.f3845d = oVar;
    }

    public final String m() {
        return "INSERT OR REPLACE INTO `pending_hourly_sync` (`id`,`parentCycleId`,`userId`,`userEmail`,`planLabel`,`cycleStartTime`,`hourStartTime`,`hourEndTime`,`packageName`,`usageMs`,`syncType`,`attempts`,`lastAttemptAt`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }
    ...
    public final void v(z0.i iVar, Object obj) {
        ...
        Object obj2 = this.f3845d.f3851e;
